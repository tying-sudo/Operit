  ...
  "tools": [
    {
      "name": "usage_advice",
      "description": {
        "zh": "DeepSeek Harness 服务使用建议。",
        "en": "DeepSeek Harness usage advice."
      },
      "parameters": [],
      "advice": true
    },
    ...
    },
    {
      ...
      "description": {
        "zh": "显式安装或更新 DeepSeek Harness 运行时到 GitHub Releases 最新版本；不会降级已安装的更高版本。",
        "en": "Explicitly install or update the DeepSeek Harness runtime to the latest GitHub Releases version; higher installed versions are never downgraded."
      },
      "parameters": []
    },
    {
...
async function usage_advice() {
    return {
        ...
        message: "Use get_deepseek_harness_server_status to inspect DeepSeek Harness Web. " +
            ...
            "stop_deepseek_harness_server when needed. DSH credentials stay in the native Web UI.",
    };
}
